...
from .const import (
    ...
    DEFAULT_EMAIL_ACTION, DEFAULT_EMAIL_MOVE_FOLDER, DEFAULT_TARIFF_PRICE,
)
    ...
    async def async_step_init(self, user_input: dict[str, Any] | None = None) -> FlowResult:
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Required(CONF_TARIFF_PRICE,
                             default=float(data.get(CONF_TARIFF_PRICE, DEFAULT_TARIFF_PRICE))): vol.Coerce(float),
            }),
        )
    ...
    async def async_step_email(self, user_input: dict[str, Any] | None = None) -> FlowResult:
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Required(CONF_TARIFF_PRICE, default=DEFAULT_TARIFF_PRICE): vol.Coerce(float),
            }),
            errors=errors,
        )
